...
namespace Shelland.ImagingLibrary.Formats
{
    ...
    /// </summary>
    public class TargaReaderCommand : IDisposable

    {
        ...
        /// </summary>
        public TargaReaderCommand(string strFileName) : this()
        {
        ...
        {
            Bitmap b = null;
            using (TargaReaderCommand ti = new TargaReaderCommand(sFileName))
            {
